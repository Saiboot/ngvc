...
#define MASK_OP		0x03FFFFFF	
#define MASK_REG1	0xFC1FFFFF
#define MASK_REG2	0xFFE0FFFF
#define MASK_REG3	0xFFFF07FF
#define MASK_SHIFT	0xFFFFF83F
#define MASK_FUNC	0xFFFFFFC0
